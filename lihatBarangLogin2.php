...
?>
    ...
    <section id="hero">
        <div id="main">
            ...
            <h2 class="judul"><strong>Lihat Data Barang </strong></h2>
            <?php
            ...
            ?>
                <center>
                    <div class='tabel-sc'>
                        <table id="tabelBarang" class="table table-striped"  onclick='tampil()'>
                            <thead>
                                <th>No.</th>
                                <th>Kode</th>
                                <th>Nama barang</th>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class='delete'><a id="hapus" data-id="<?php echo $row["Kode_Barang"] ?>" href='#'>
                                                <ion-icon name='trash-outline'></ion-icon>
                                            </a></td>
                                        <td class='edit'><a id="edit" data-id="<?php echo $row["Kode_Barang"] ?>" href='#''>
    ...
    <script>
        ...
        $('#tabelBarang #edit').click(function() {
            var id = $(this).attr('data-id');
            document.cookie = "var1=" + id + "", window.location = "editBarang.php"
        })

        $('#tabelBarang #hapus').click(function() {
            var id = $(this).attr('data-id');
            Swal.fire({
                title: 'Apakah anda Yakin?',
                ...
                if (result.isConfirmed) {
                    document.cookie = "var1=" + id + "", window.location = "hapusBarang.php"
                    Swal.fire(
                        'Terhapus!',
